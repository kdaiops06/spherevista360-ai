    ...
    return (
      <div className="card">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className={`text-sm font-bold ${globalLevel.color}`}>
            {globalLevel.label}
          </span>
        </div>
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Composite score updated daily from 5 risk categories
        </p>
      </div>
      ...
      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
        ...
        <p className="text-sm text-gray-600">
          The Global Risk Score is a composite index computed from five weighted
          risk categories. Each category aggregates multiple economic indicators
          including yield curve data, CPI, PMI, sovereign debt ratios, forex
          reserves, and geopolitical event indices. Scores range from 0 (minimal
          risk) to 100 (critical risk). Data is refreshed daily from FRED, World
